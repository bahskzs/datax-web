 ...
 *@description
 */
@ApiModel(description="t_history_user_role_office")
@Data
public class HistoryUserRoleOffice implements Serializable {
    ...
    public HistoryUserRoleOffice(String userGuid,String belongYear, String code, String name,String govid) {
        this.userGuid = userGuid;
